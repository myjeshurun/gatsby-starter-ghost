module.exports = {
    siteUrl: `https://seekgod.herokuapp.com`, // Site domain. Do not include a trailing slash!

    postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

    siteTitleMeta: `Ghost`, // This allows an alternative site title for meta data for pages.
